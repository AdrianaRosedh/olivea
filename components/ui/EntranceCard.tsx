...
export function EntranceCard({ href, label, desc }: EntranceCardProps) {
  return (
    <Link href={href} className="group relative w-64 h-40">
      ...
      <div
        className={cn(
          "absolute inset-0 rounded-xl bg-linear-to-br from-(--olivea-olive) to-(--olivea-sage) opacity-20",
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-col items-center justify-center h-full rounded-xl backdrop-blur-md bg-white/10 border border-white/20 text-(--olivea-ink)"
      >
