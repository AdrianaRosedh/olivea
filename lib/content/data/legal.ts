...
const legal: LegalContent = {
  meta: {
    ...
    description: {
      es: "Aviso de Privacidad y Términos y Condiciones de Inmobiliaria MYA by DH. — Olivea Farm To Table, Casa Olivea y Olivea Café Wine Bar en Valle de Guadalupe.",
      en: "Privacy Notice and Terms & Conditions of Inmobiliaria MYA by DH. — Olivea Farm To Table, Casa Olivea and Olivea Café Wine Bar in Valle de Guadalupe.",
    },
  ...
  description: {
    es: "Aviso de Privacidad y Términos y Condiciones de Inmobiliaria MYA by DH. · Última actualización: 29 de junio de 2026.",
    en: "Privacy Notice and Terms & Conditions of Inmobiliaria MYA by DH. · Last updated: June 29, 2026.",
  },
  sections: [
    ...
    section("responsable", 1,
      ...
      {
        es: `Inmobiliaria MYA by DH. («Olivea», «nosotros») es responsable del tratamiento de tus datos personales, conforme a la legislación mexicana de protección de datos personales en posesión de los particulares vigente (incluida la reforma de 2025) y demás normativa aplicable.
...
Contacto en materia de privacidad: hola@casaolivea.com · +52 646 388 2369.`,
        en: `Inmobiliaria MYA by DH. ("Olivea," "we," "us") is responsible for the processing of your personal data, in accordance with Mexico's current law on the protection of personal data held by private parties (including the 2025 reform) and other applicable rules.
...
On your first visit you'll see a notice where you can Accept or choose Essential only. By default, non-essential cookies stay off until you accept them (we use Google Consent Mode). You can change or withdraw your consent at any time from the "Cookies" link in the footer, or through your browser settings.`,
    ...
    section("responsabilidad", 18,
      ...
      {
        es: `Procuramos que la información del Sitio sea correcta y esté actualizada, pero se ofrece «tal cual», sin garantía de que esté libre de errores o interrupciones. En la medida que lo permita la ley aplicable, Inmobiliaria MYA by DH. no será responsable por daños o perjuicios derivados del uso del Sitio.`,
        en: `We strive to keep the Site's information accurate and current, but it is provided "as is," without warranty that it is free of errors or interruptions. To the extent permitted by applicable law, Inmobiliaria MYA by DH. shall not be liable for any damages arising from use of the Site.`,
      }),
...
Inmobiliaria MYA by DH. · Carretera Ensenada–Tecate Km 92.5, Villa de Juárez, Ensenada, Baja California, C.P. 22766, México.
hola@casaolivea.com · +52 646 388 2369.`,
        en: `Questions about privacy or these terms? Contact us:
Inmobiliaria MYA by DH. · Carretera Ensenada–Tecate Km 92.5, Villa de Juárez, Ensenada, Baja California, 22766, Mexico.
hola@casaolivea.com · +52 646 388 2369.`,
      }),
  ],
};
