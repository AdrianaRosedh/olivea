...
function buildCsp({
  ...
  const directives = [
    ...
    "form-action 'self'",
    `connect-src 'self' data: https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://challenges.cloudflare.com https://static1.cloudbeds.com https://hotels.cloudbeds.com https://plugins.whistle.cloudbeds.com https://www.opentable.com https://www.opentable.com.mx https://*.execute-api.us-west-2.amazonaws.com https://www.canva.com https://connect.facebook.net https://*.canva.com https://roseiies.com https://roseiies-tenant.vercel.app${cloudbedsConnectExtra}${locatorConnectExtra}`,
    ...
    `img-src 'self' data: blob: https://www.google-analytics.com https://static1.cloudbeds.com https://hotels.cloudbeds.com https://plugins.whistle.cloudbeds.com https://images.unsplash.com https://www.opentable.com https://www.opentable.com.mx https://*.canva.com https://lh3.googleusercontent.com https://tile.openstreetmap.org https://roseiies.com https://roseiies-tenant.vercel.app${cloudbedsImgExtra}${locatorImgExtra}`,
    "media-src 'self' blob:",
