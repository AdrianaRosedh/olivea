...
>
  ...
  <Sub id="origen" preset="blur-up" className="mt-7 md:mt-8 !min-h-0">
    Olivea Café Wine Bar es la expresión más relajada del ecosistema Olivea — donde la mañana se
  ...
  <Reveal preset="fade" delay={0.18}>
    <div className="mt-6 md:mt-7">
      <StatChips
        items={[
          { label: "Horario", value: "Diario • 7:15am – 6:15pm" },
  ...
  <Sub id="barra" preset="fade" className="mt-7 md:mt-8 !min-h-0 !mb-0">
    Olivea Café Wine Bar se vive con calma. Por las tardes, ofrecemos una selección pequeña de
