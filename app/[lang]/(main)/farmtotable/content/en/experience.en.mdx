...
>
  ...
  <Sub id="origin" preset="blur-up" className="mt-10">
    ...
    memory through time, technique, and restraint. Every evening begins in the
    garden itself — a walk through the rows where the meal was grown, so the
    first course arrives already familiar.
  </Sub>
  ...
  <Reveal preset="fade" delay={0.18}>
    <div className="mt-8">
      <StatChips
        items={[
          { label: "Format", value: "Tasting menu • 9 courses" },
          { label: "Season", value: "Changes with the garden, not the calendar" },
  ...
  <Reveal preset="fade" delay={0.14}>
    <div className="mt-10">
      <FieldNote>
        The evening need not end at the table. The fourteen suites of
        <strong> Casa Olivea</strong> open onto the same garden — dine, walk a
        few steps, and wake inside the huerto.
      </FieldNote>
    </div>
  </Reveal>
</StickyBlock>
