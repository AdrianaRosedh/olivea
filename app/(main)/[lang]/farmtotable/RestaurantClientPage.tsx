...
export default function RestaurantClientPage({ dict }: RestaurantClientPageProps) {
  ...
  useEffect(() => {
    ...
    const targetVideo = (stored || "/videos/farmtotable.mp4").trim();
  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* WebM first */}
          <source src="/videos/farmtotable.webm" type="video/webm" />
          {/* MP4 fallback */}
          <source src="/videos/farmtotable.mp4" type="video/mp4" />
