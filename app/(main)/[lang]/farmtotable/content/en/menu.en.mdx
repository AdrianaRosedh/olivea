...
>
  ...
  <div className="mt-8 md:mt-9 text-center">
    <p className="mx-auto max-w-[70ch] text-[17px] md:text-[18px] leading-[1.7] text-[var(--olivea-ink)]/90">
      A seasonal <strong>9-course tasting menu</strong>, composed as a single
      journey. The menu shifts{" "}
      <strong>with the garden</strong>, guided by what the garden and the season offer
      at their peak.
    </p>
