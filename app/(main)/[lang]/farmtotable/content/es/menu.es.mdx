...
>
  ...
  <div className="mt-8 md:mt-9 text-center">
    <p className="mx-auto max-w-[70ch] text-[17px] md:text-[18px] leading-[1.7] text-[var(--olivea-ink)]/90">
      Un <strong>menú degustación de 8 tiempos</strong>, concebido como un solo
      recorrido. El menú cambia aproximadamente cada{" "}
      <strong>5–6 semanas</strong>, guiado por lo que el huerto y la temporada
      ofrecen en su punto.
    </p>
