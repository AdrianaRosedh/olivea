...
>
  ...
  <div className="mt-8 md:mt-9 text-center">
    <div className="mx-auto max-w-[70ch] text-[17px] md:text-[18px] leading-[1.7] text-[var(--olivea-ink)]/90">
      ...
      <Farmpop
        ...
        tabs={[
          ...
          },
          {
            id: "maridaje",
            label: "Maridaje",
            url: "https://roseiies.com/r/olivea/maridaje",
            emoji: "🌿",
          },
          {
            id: "non-alcoholic",
          ...
          },
          {
            id: "vinos",
            label: "Vinos",
            url: "https://roseiies.com/r/olivea/carta-biblioteca",
            emoji: "🍷",
          },
          {
            id: "bebidas",
  ...
  <div className="mt-8 grid gap-5 md:gap-6 md:grid-cols-2 lg:grid-cols-4">
    <div className="relative overflow-hidden rounded-2xl bg-white/22 backdrop-blur-sm ring-1 ring-black/8 px-5 py-5 md:px-6 md:py-6">
      ...
      <div className="mt-3 text-[15px] leading-[1.65] text-[var(--olivea-ink)]/82">
    ...
    <div className="relative overflow-hidden rounded-2xl bg-white/22 backdrop-blur-sm ring-1 ring-black/8 px-5 py-5 md:px-6 md:py-6">
      ...
      <div className="mt-3 text-[15px] leading-[1.65] text-[var(--olivea-ink)]/82">
        ...
        tiempo a tiempo. Descorche: <strong>$500 MXN por botella, o $900 MXN por mágnum</strong>.
      </div>
    </div>
