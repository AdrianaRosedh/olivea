  ...
  return (
    ...
    >
      ...
      <div className="relative mt-6">
        ...
        >
          <CardParallax
            ...
            alt="Olivea Café Wine Bar — menú y atmósfera"
            speed={0.12}
            fit="cover"
      ...
      <div className="mt-8 md:mt-9 text-center">
        <div className="mx-auto max-w-[72ch] text-[17px] md:text-[18px] leading-[1.7] text-[var(--olivea-ink)]/90">
        ...
        <div className="mt-6 flex justify-center">
          <Farmpop
            ...
            canvaUrl="https://www.canva.com/design/DAGjvAZxZhE/EwbugVOorA1VUbXx8wNmhw/view"
            triggerClassName="
