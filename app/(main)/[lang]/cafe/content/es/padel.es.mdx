...
>
  <Reveal preset="up"><h2 className="text-2xl md:text-4xl font-semibold mb-4 md:mb-6">Pádel</h2></Reveal>

  <div className="space-y-6 md:space-y-8">
    <Sub id="comunidad" preset="up">Canchas, torneos amistosos y clases…</Sub>

    <div className="relative overflow-hidden rounded-[28px] ring-1 ring-black/10 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.35)]">
      <ParallaxImage src="/images/cafe/padel.jpg" alt="Canchas de pádel" heightVh={46} speed={0.22} />
    </div>

    <Sub id="servicios" preset="fade">Tienda, renta de equipo y eventos…</Sub>
  </div>
</StickyBlock>