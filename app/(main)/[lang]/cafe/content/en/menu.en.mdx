    ...
    >
      ...
      <div className="relative mt-6">
        ...
        >
          <CardParallax
            ...
            alt="Olivea Café — menu and atmosphere"
            speed={0.12}
            fit="cover"
      ...
      <div className="mt-8 md:mt-9 text-center">
        <p className="mx-auto max-w-[72ch] text-[17px] md:text-[18px] leading-[1.7] text-[var(--olivea-ink)]/90">
          A curated <strong>coffee + café menu</strong>, designed around clarity and rhythm —
        ...
        <div className="mt-6 flex justify-center">
          <Farmpop
            ...
            initialTabId="coffee"
            tabs={[
              { id: "coffee", label: "Coffee", url: "https://www.canva.com/design/REPLACE_ME/view", emoji: "☕️" },
              { id: "breakfast", label: "Breakfast", url: "https://www.canva.com/design/REPLACE_ME/view", emoji: "🥐" },
              { id: "tea", label: "Tea", url: "https://www.canva.com/design/REPLACE_ME/view", emoji: "🍵" },
              { id: "cold", label: "Cold", url: "https://www.canva.com/design/REPLACE_ME/view", emoji: "🧊" },
            ]}
            triggerClassName="
      ...
      <div className="mt-8 grid gap-5 md:gap-6 md:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/22 backdrop-blur-sm ring-1 ring-black/8 px-5 py-5 md:px-6 md:py-6">
          <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-[var(--olivea-olive)]/35" />
          <div className="text-[12px] uppercase tracking-[0.18em] text-[var(--olivea-olive)]/85">
            🍵 Matcha • garden jarabes
          </div>
          <p className="mt-3 text-[15px] leading-[1.65] text-[var(--olivea-ink)]/82">
            Ceremonial matcha, prepared with technique. Seasonal syrups and jarabes evolve with the garden —
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/22 backdrop-blur-sm ring-1 ring-black/8 px-5 py-5 md:px-6 md:py-6">
          <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-[var(--olivea-olive)]/35" />
          <div className="text-[12px] uppercase tracking-[0.18em] text-[var(--olivea-olive)]/85">
            🍷 Afternoons • small list
          </div>
          <p className="mt-3 text-[15px] leading-[1.65] text-[var(--olivea-ink)]/82">
            Afternoons offer a small selection of cocktails, wine, and tapas — a relaxed continuation of the day,
