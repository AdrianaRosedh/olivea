        ...
        <div className="pointer-events-auto text-center px-4">
          ...
          <Reveal preset="up" delay={0.18}>
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              {/* Scroll to Rooms (change target id if your section differs) */}
              <a
                href="#rooms"
                aria-label="View rooms"
                onClick={(e) => {
                  e.preventDefault();
                  const el = document.getElementById('rooms') || document.querySelector('.main-section#rooms');
                  if (!el) return;
                  ...
                  if (window.location.hash.slice(1) !== 'rooms') history.replaceState(null, '', '#rooms');
                }}
                className="
                  inline-flex items-center justify-center
                  rounded-full px-4 py-2 text-sm font-medium tracking-wide
