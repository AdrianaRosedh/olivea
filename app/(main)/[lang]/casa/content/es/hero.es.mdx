          ...
          <Reveal preset="up" delay={0.18}>
            <div className="mt-6 flex items-center justify-center gap-3">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  const el = document.getElementById('habitaciones') || document.querySelector('.main-section#habitaciones');
                  if (!el) return;
                  ...
                  if (window.location.hash.slice(1) !== 'habitaciones') history.replaceState(null, '', '#habitaciones');
                }}
                className="
                  inline-flex items-center justify-center
                  rounded-full px-4 py-2 text-sm font-medium tracking-wide
