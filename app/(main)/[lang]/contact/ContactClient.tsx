// app/(main)/[lang]/contact/ContactClient.tsx
"use client";
...
export default function ContactClient({ lang, t, contactInfo }: Props) {
  ...
  const address = "Carretera Ensenada-Tecate Km 92.5, 22766 Villa de Juárez, Baja California";
            ...
            <div className="grid gap-10 lg:gap-12 items-start lg:grid-cols-[minmax(560px,1.15fr)_minmax(520px,0.85fr)]">
              ...
              >
                <motion.div
                  variants={itemInV}
                  custom={0}
                  className="lg:max-w-160 lg:ml-auto"
                >
                    ...
                    <div className="relative h-130 lg:h-[min(720px,calc(100vh-220px))]">
                      ...
                      >
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-2 rounded-full bg-white/70 backdrop-blur px-3 py-2 ring-1 ring-black/5 text-xs text-(--olivea-ink)/75 hover:text-(--olivea-ink) transition"
                        >
                          {t.map.googleMapsCta}
