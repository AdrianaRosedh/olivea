...
seo:
  title: "Hospitalidad con raíz en el huerto — Cómo Olivea diseña la hospitalidad contemporánea"
  description: "Un ensayo desde la práctica: cómo Olivea diseña sistemas y experiencias de hospitalidad a partir del huerto."
  keywords:
    - hospitalidad con raíz en el huerto
    - sistemas de hospitalidad
    - filosofía huerto a mesa
    - diseño de hospitalidad sostenible
    - hospitalidad en Valle de Guadalupe
  faq:
    - q: "¿Qué es la hospitalidad con raíz en el huerto?"
      a: "Es un enfoque donde el huerto informa decisiones operativas, gastronómicas y de experiencia, más allá de lo decorativo."
    - q: "¿Cómo integra Olivea el huerto en su modelo?"
      a: "El huerto define la estacionalidad, el menú, el ritmo del servicio y la estructura de la experiencia."
    - q: "¿La hospitalidad con raíz en el huerto es sostenible?"
      a: "Sí. Al tratar el huerto como infraestructura, la sostenibilidad se vuelve una consecuencia operativa, no un discurso."
---
